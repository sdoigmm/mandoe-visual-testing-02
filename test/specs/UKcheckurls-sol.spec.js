...
describe('Mandoe Media UK production environment-solutions pages', () => {
  ...
  it('TCS-001-Solutions- Hospitality header Start Free trial button  link  -  https://mandoemedia.com/en-gb/industries/hospitality/', async () => {
  ...
  it('TCS-002-Solutions- Hospitality header Make a digital sign button  link  -  https://mandoemedia.com/en-gb/industries/hospitality/', async () => {
    await browser.url("/en-gb/industries/hospitality/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-003-Solutions- Hospitality Start free trial on the middle image bar button link  -  https://mandoemedia.com/en-gb/industries/hospitality/', async () => {
    await browser.url("/en-gb/industries/hospitality/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-004-Solutions- Solutions- Hospitality Start free trial button on the footer  -  https://mandoemedia.com/en-gb/industries/hospitality/', async () => {
    await browser.url("/en-gb/industries/hospitality/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-005-Solutions- Solutions- Hospitality make a video its free button on the footer  -  https://mandoemedia.com/en-gb/industries/hospitality/', async () => {
    await browser.url("/en-gb/industries/hospitality/")
  ...
  it('TCS-006-Solutions- Usecases Digital menuboard Start Free trial-01 button  -  https://mandoemedia.com/en-gb/usecase/digital-menuboards/', async () => {
  ...
  it('TCS-007-Solutions- Usecases Digital menuboard Make a Digital menu/Window signange/In-store signange/videowall button  -  https://mandoemedia.com/en-gb/usecase/digital-menuboards/', async () => {
    await browser.url("/en-gb/usecase/digital-menuboards/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-008-Solutions- Usecases Digital menuboard Start Free trial-02 button  -  https://mandoemedia.com/en-gb/usecase/digital-menuboards/', async () => {
    await browser.url("/en-gb/usecase/digital-menuboards/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-009-Solutions- Usecases Digital menuboard footer Start Free trial-03 button  -  https://mandoemedia.com/en-gb/usecase/digital-menuboards/', async () => {
    await browser.url("/en-gb/usecase/digital-menuboards/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-010-Solutions- Usecases Digital menuboard footer Make a video its free button  -  https://mandoemedia.com/en-gb/usecase/digital-menuboards/', async () => {
    await browser.url("/en-gb/usecase/digital-menuboards/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-011-Solutions- Enterprise Contact our team button  -  https://mandoemedia.com/en-gb/enterprise/', async () => {
  ...
  it('TCS-012-Solutions- Enterprise Contact us button  -  https://mandoemedia.com/en-gb/enterprise/', async () => {
    await browser.url("/en-gb/enterprise/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  //======================Solutions- Customers
  it('TCS-013-Solutions- Customer start free trial -01 header button  -  https://mandoemedia.com/en-gb/customers/', async () => {
  ...
  it('TCS-014-Solutions- Customer make a video its free-01 header button  -  https://mandoemedia.com/en-gb/customers/', async () => {
    await browser.url("/en-gb/customers/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-015-Solutions- Customer start free trial-02 footer button  -  https://mandoemedia.com/en-gb/customers/', async () => {
    await browser.url("/en-gb/customers/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCS-016-Solutions- Customer make a video its free-02 Footer button  -  https://mandoemedia.com/en-gb/customers/', async () => {
    await browser.url("/en-gb/customers/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
