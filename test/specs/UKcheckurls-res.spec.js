...
describe('Mandoe Media UK production environment-resources pages', () => {
  ...
  it('TCR-001-Resources - Blog start free trial 01 button  link -  https://mandoemedia.com/en-gb/blog/', async () => {
  ...
  it('TCR-002-Resources - Blog footer Get started free button  link -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-003-Resources - Blog Digital signage Tips Main link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    await assert.equal('Digital Signage Tips Archives - Mandoe United Kingdom', title, 'title is not found')
  });

  it('TCR-004-Resources - Blog Digital signage Tips link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-005-Resources - Blog Case Studies Main link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    const title = await browser.getTitle()
    await console.log('Resources - Blog Digital signage Tips main link opens:', title);
    await assert.equal('Case Studies Archives - Mandoe United Kingdom', title, 'title is not found')
  });
  it('TCR-006-Resources - Blog Case Studies link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-007-Resources - Blog News updates  Main link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    await assert.equal('News & Updates Archives - Mandoe United Kingdom', title, 'title is not found')
  });
  it('TCR-008-Resources - Blog News updates link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  //============Design inspiration ====================
  it('TCR-009-Resources - Blog Design inspiration  Main link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    await assert.equal('Design & Inspiration Archives - Mandoe United Kingdom', title, 'title is not found')
  });
  it('TCR-010-Resources - Blog Design inspiration link  -  https://mandoemedia.com/en-gb/blog/', async () => {
    await browser.url("/en-gb/blog/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-011-Resources - Blog food-sustainability make a video its free button  link  -  https://mandoemedia.com/en-gb/blog/elements-and-templates-food-sustainability/', async () => {
    await browser.url("/en-gb/elements-and-templates-food-sustainability/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-012-Resources - Blog food-sustainability Get started button  link  -  https://mandoemedia.com/en-gb/blog/elements-and-templates-food-sustainability/', async () => {
    await browser.url("/en-gb/elements-and-templates-food-sustainability/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-013-Resources - Blog food-sustainability Footer Get started free button  link  -  https://mandoemedia.com/en-gb/blog/elements-and-templates-food-sustainability/', async () => {
    await browser.url("/en-gb/elements-and-templates-food-sustainability/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  //===============Case studies
  it('TCR-014-Resources - case-studies Get started button  link  -  https://mandoemedia.com/en-gb/blog/topic/case-studies/', async () => {
  ...
  it('TCR-015-Resources - case-studies Get started free button  link  -  https://mandoemedia.com/en-gb/blog/topic/case-studies/', async () => {
    await browser.url("/en-gb/blog/topic/case-studies/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-016-software-only-pricing 14 day free trial left  -  https://mandoemedia.com/en-gb/pricing/software-only-pricing/', async () => {
    await browser.url("/en-gb/pricing/software-only-pricing/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-017-software-only-pricing 14 day free trial right  -  https://mandoemedia.com/en-gb/pricing/software-only-pricing/', async () => {
    await browser.url("/en-gb/pricing/software-only-pricing/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-018-software-only-pricing Get started free trial right  -  https://mandoemedia.com/en-gb/pricing/software-only-pricing/', async () => {
    await browser.url("/en-gb/pricing/software-only-pricing/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-019-About start free trial  -  https://mandoemedia.com/en-gb/about-us/ ', async () => {
  ...
  it('TCR-020-About Make a video its free https://mandoemedia.com/en-gb/about-us/ ', async () => {
    await browser.url("/en-gb/about-us/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  //==============locations ====================
  it('TCR-021-locations page first location  -  https://mandoemedia.com/en-gb/locations/', async () => {
    await browser.url("/en-gb/locations/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    await assert.equal('Get Digital Signage in Sutton | Mandoe Media', title, 'title is not found')
  });
  it('TCR-022-locations page first location learnmore  -  https://mandoemedia.com/en-gb/locations/ ', async () => {
    await browser.url("/en-gb/locations/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCR-023-locations page third location  -  https://mandoemedia.com/en-gb/locations/', async () => {
    await browser.url("/en-gb/locations/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
    ...
    await assert.equal('Get Digital Signage in Preston | Mandoe Media', title, 'title is not found')
  });
  it('TCR-024-locations page Third location learnmore  -  https://mandoemedia.com/en-gb/locations/', async () => {
    await browser.url("/en-gb/locations/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
