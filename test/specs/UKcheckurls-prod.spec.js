...
describe('Mandoe Media UK production environment-products pages', () => {
  ...
  it('TCP-001-Home page Header Nav start free trial link -  https://mandoemedia.com/en-gb/', async () => {
  ...
  it('TCP-002-Home page Header Nav Login  link -  https://mandoemedia.com/en-gb/', async () => {
    await browser.url("/en-gb/")
    await browser.pause(4000)
  ...
  it('TCP-003-Home page Start Free trial 02-hero button link -  https://mandoemedia.com/en-gb/', async () => {
    await browser.url("/en-gb/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-004-Home page Make a video its free 01-hero button link -  https://mandoemedia.com/en-gb/', async () => {
    await browser.url("/en-gb/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-005-Home page footer start free trial link -  https://mandoemedia.com/en-gb/', async () => {
  ...
  it('TCP-006-Home page footer Make a video its free 02 link -  https://mandoemedia.com/en-gb/', async () => {
    await browser.url("/en-gb/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await (await HomePage.scrollToSvg).scrollIntoView()
  ...
  // //===============================Features======================================================
  it('TCP-007-Features page Start Free trial 01 link -  https://mandoemedia.com/en-gb/features/', async () => {
  ...
  it('TCP-008-Features page Make a video its free 01 button link -  https://mandoemedia.com/en-gb/features/', async () => {
    await browser.url("/en-gb/features/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-009-Features page footer start free trial  button link -  https://mandoemedia.com/en-gb/features/', async () => {
    await browser.url("/en-gb/features/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-010-Features page footer Make a video its free 02  button link -  https://mandoemedia.com/en-gb/features/', async () => {
    await browser.url("/en-gb/features/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-011-How it works page Get started for free button link -  https://mandoemedia.com/en-gb/how-it-works/', async () => {
  ...
  it('TCP-012-How it works page Sign up for free button 01 link -  https://mandoemedia.com/en-gb/how-it-works/', async () => {
    await browser.url("/en-gb/how-it-works/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-013-How it works page Sign up for free button 02 link -  https://mandoemedia.com/en-gb/how-it-works/', async () => {
    await browser.url("/en-gb/how-it-works/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-014-How it workspage Footer Get started free button -  https://mandoemedia.com/en-gb/how-it-works/', async () => {
    await browser.url("/en-gb/how-it-works/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-015-Templates page Footer Get started free button -  https://mandoemedia.com/en-gb/templates/', async () => {
  ...
  it('TCP-016-TC Hospitality  page Header Start your 14 day free trial button -  https://mandoemedia.com/en-gb/templates/hospitality/', async () => {
  ...
  //=====================Industries2 =========================================
  it('TCP-017-Industries page footer Get started free -  https://mandoemedia.com/en-gb/industries2/', async () => {
  ...
  it('TCP-018-player hardware Buy media player button link -  https://mandoemedia.com/en-gb/guides/connecting-the-player/', async () => {
  ...
  it('TCP-019-player hardware Activate player button link -  https://mandoemedia.com/en-gb/guides/connecting-the-player/', async () => {
    await browser.url("/en-gb/guides/connecting-the-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-020-player hardware Activate mandoemedia text link -  https://mandoemedia.com/en-gb/guides/connecting-the-player/', async () => {
    await browser.url("/en-gb/guides/connecting-the-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-021-player hardware Footer Get started Free button link( -  https://mandoemedia.com/en-gb/guides/connecting-the-player/', async () => {
    await browser.url("/en-gb/guides/connecting-the-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-022-player software  Footer Start free trial button link -  https://mandoemedia.com/en-gb/download-player/', async () => {
  ...
  it('TCP-023-player software  Footer Make a video - its free button  link -  https://mandoemedia.com/en-gb/download-player/', async () => {
    await browser.url("/en-gb/download-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-024-Player software download windows link -  https://mandoemedia.com/en-gb/download-player/', async () => {
    await browser.url("/en-gb/download-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-025-Player software download macOS link -  https://mandoemedia.com/en-gb/download-player/', async () => {
    await browser.url("/en-gb/download-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
  ...
  it('TCP-026-Player software download linux link -  https://mandoemedia.com/en-gb/download-player/', async () => {
    await browser.url("/en-gb/download-player/")
    await browser.pause(4000)
    await (await HomePage.topNavStartFreeTrialBtn).moveTo()
    await browser.pause(20000)
